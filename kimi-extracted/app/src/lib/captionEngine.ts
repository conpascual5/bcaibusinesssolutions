...
const facebookCaptions = [
  ...
  "Sino ang gusto ng upgrade? 🙋‍♀️ I-try ang {product} at feel the difference! Premium quality na abot-kaya.",
...
const tiktokCaptions = [
  ...
  "my honest review of {product} after 1 month ⭐️ spoiler: worth it! #review",
  "yung feeling na may {product} ka 💆‍♀️✨ ang sarap sa feeling! #satisfying",
...
export function generateImageCaptions(description: string, _imageDataUrl: string): ImageCaption[] {
  // Use the image data URL as part of the seed for uniqueness per image
