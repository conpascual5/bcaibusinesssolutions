...
const FIRST_NAMES = [
  ...
  "Grace", "Joey", "Lorna", "Paolo", "Tina", "Ricky", "Marilou", "Allan",
  "Diana", "Edwin", "Cristina", "Rodel", "Shiela", "Jun", "Karen", "Nico",
  "Aileen", "Rafael", "Gina", "Tomas", "Vicky", "Erwin", "Marlon", "Brenda",
  ...
  "Herminio", "Corazoncita", "Norberto", "Remedios", "Rufino", "Aurora",
  "Simeon", "Perlita", "Teofilo", "Rosalinda", "Anacleto", "Gloriosa",
  "Ponciano", "Natividad", "Rodolfo", "Elena", "Benjamin", "Teresita",
  "Lucio", "Josefina", "Antonio", "Adelaida", "Manuel", "Oscar", "Lourdes",
