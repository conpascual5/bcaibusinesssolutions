...
const ACTIONS = [
  ...
  "just unlocked VIP access",
  "just generated their first ad",
  "just created a sales caption",
  "just analyzed their first image",
  "just generated an invoice",
  "just created a sales report",
];
