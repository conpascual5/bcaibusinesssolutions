...
import type { PayrollPeriod } from "@/pages/BusinessPayroll";
...
export default function PayrollPeriodManager({ businessOwnerId, payrollPeriods, onRefresh }: Props) {
    ...
    <div className="space-y-4">
      <div className="flex justify-end">
        <button onClick={() => setShowForm(true)}
          ...
          <Plus className="w-4 h-4" /> New Payroll Period
        </button>
      </div>
