...
import { Calculator, Pencil, Trash2, Clock, Loader2 } from "lucide-react"
import { supabase } from "@/integrations/supabase/client"
import type { Deduction } from "@/pages/StandaloneHRPayroll"
...
export default function StandaloneDeductionManager({ businessOwnerId, deductions, onRefresh }: Props) {
    ...
    <div className="space-y-4">
      <div className="flex justify-end">
        <button onClick={openNew}
          ...
          <Calculator className="w-4 h-4" /> Add Deduction
        </button>
      </div>
