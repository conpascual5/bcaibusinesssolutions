...
import { UserCheck, Calendar, Receipt, Calculator, Loader2 } from "lucide-react"
import type { Employee, PayrollPeriod, Payslip, Deduction } from "@/pages/StandaloneHRPayroll"
...
export default function StandalonePayrollDashboard({ employees, payrollPeriods, payslips, deductions, onGenerate, getEmployee, fmtCurrency }: Props) {
  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          { icon: UserCheck, color: "indigo", label: "Active Employees", value: totalEmployees },
          { icon: Calendar, color: "emerald", label: "Payroll Periods", value: payrollPeriods.length },
          { icon: Receipt, color: "amber", label: "Payslips Generated", value: payslips.length },
          { icon: Calculator, color: "rose", label: "Deduction Types", value: deductions.length },
        ].map((item, i) => (
