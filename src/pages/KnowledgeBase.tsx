...
const entries: KBEntry[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: "Pricing", content: "GCash Cash In/Out is available as a standalone add-on for ₱299/month (was ₱699/month)." },
    ],
  },
  {
    id: "bms",
    ...
    sections: [
      { heading: "What is BMS?", content: "The Business Management System is a comprehensive suite of 16+ trackers covering products, inventory, sales, expenses, pricing, finance, customers, invoices, receipts, targets, records, and team management." },
      ...
      { heading: "Key Modules", content: "Products: Manage your product catalog. Inventory: Track stock levels. Sales: Log daily sales. Expenses: Record business expenses. Pricing: Calculate optimal prices. Finance: View profit/loss. Customers: Manage client list." },
      { heading: "Pricing", content: "BMS is available as a standalone add-on for ₱999/month. Access is granted per user upon request. Each team member added to your account costs ₱69/month per member." },
      { heading: "Team Collaboration", content: "Business owners can add team members who can view and manage business data. Team members see a banner indicating they're viewing the owner's data. Access is controlled through the Team module. Each team member costs ₱69/month per member." },
    ],
  },
  {
    id: "hr-management",
    ...
    sections: [
      { heading: "What is HR Management System?", content: "A standalone HR operations suite covering employee profiles, attendance tracking with live real-time monitoring, shift roster scheduling, performance reviews, payroll engine with bonuses, company/office/department/designation management, and a dedicated mobile-friendly Employee Portal for clock in/out. Available as a standalone add-on for ₱999/month (up to 10 employees, ₱69/month per additional employee)." },
      { heading: "Getting Started", content: "Access HR Management from the sidebar under 'HR Management'. Subscribe to the standalone HR add-on for ₱999/month (up to 10 employees, ₱69/month per additional employee). Once inside, you'll see the HR Dashboard with an overview of all HR metrics." },
      { heading: "Key Modules", content: "Employees: Manage employee profiles with roles and status. Attendance: Track daily attendance with time-in/time-out and live real-time monitoring dashboard. Shift Roster: Create and assign shift schedules — auto-syncs to attendance & payroll. Corrections: Handle attendance corrections. Performance: Track employee performance reviews. Payroll Engine: Generate automated payslips with attendance-based computation, deductions, and net pay breakdown. Employee Portal: Self-service portal for employees to clock in/out and view schedules." },
      ...
      { heading: "Pricing & Seat Limits", content: "Standalone HR Management is ₱999/month for up to 10 employees, with ₱69/month per additional employee beyond 10. The system enforces a seat limit — you can only add as many employees as your seat count allows. If you need more seats, contact us via Facebook and we can manually increase your limit. The seat count is adjustable from the Admin panel." },
    ],
  },
  {
    id: "employee-portal",
    ...
    gradient: "from-indigo-500 to-purple-500",
    sections: [
      { heading: "What is Employee Portal?", content: "A dedicated self-service portal where employees can clock in/out, view their daily schedule (shift name, start/end time, break schedule, grace period), and track their attendance history — all without needing to contact HR. The portal is fully mobile-friendly with large tap targets and a bottom navigation bar, making it easy to use on any phone." },
      ...
      { heading: "Clock In / Clock Out", content: "The main clock card shows the employee's schedule for today (shift name, start/end time, break schedule, grace period). Tapping 'Clock In' records the time and auto-determines if they're 'present' or 'late' by comparing against the shift start time + grace period. Tapping 'Clock Out' calculates total hours worked. Rest days show a special message and disable clock in. The clock button is designed with large tap targets for easy use on mobile phones — just tap to clock in or out from anywhere." },
