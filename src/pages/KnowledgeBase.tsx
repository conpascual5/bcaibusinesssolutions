...
const entries: KBEntry[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: "Pricing", content: "BMS is available as a standalone add-on for ₱999/month. Access is granted per user upon request. HR Management System is ₱999/month for up to 10 users (₱69/month per additional user)." },
  ...
  },
  {
    ...
    sections: [
      { heading: "What is HR Management System?", content: "A standalone HR operations suite covering employee profiles, attendance tracking with live real-time monitoring, leave management, shift roster scheduling, performance reviews, payroll engine with bonuses, company/office/department/designation management, and a dedicated mobile-friendly Employee Portal for clock in/out and leave requests. Available as a standalone add-on for ₱999/month (up to 10 users, ₱69/month per additional user)." },
      { heading: "Getting Started", content: "Access HR Management from the sidebar under 'HR Management'. Subscribe to the standalone HR add-on for ₱999/month (up to 10 users, ₱69/month per additional user). Once inside, you'll see the HR Dashboard with an overview of all HR metrics." },
      { heading: "Key Modules", content: "Employees: Manage employee profiles with roles and status. Attendance: Track daily attendance with time-in/time-out and live real-time monitoring dashboard. Leave: Manage leave requests with different leave types. Shift Roster: Create and assign shift schedules — auto-syncs to attendance & payroll. Corrections: Handle attendance corrections. Performance: Track employee performance reviews. Payroll Engine: Generate automated payslips with attendance-based computation, deductions, and net pay breakdown. Employee Portal: Self-service portal for employees to clock in/out, view schedules, and submit leave requests." },
  ...
  },
  {
    ...
    gradient: "from-indigo-500 to-purple-500",
    sections: [
      { heading: "What is Employee Portal?", content: "A dedicated self-service portal where employees can clock in/out, view their daily schedule (shift name, start/end time, break schedule, grace period), track their attendance history, and submit leave requests — all without needing to contact HR. The portal is fully mobile-friendly with large tap targets and a bottom navigation bar, making it easy to use on any phone." },
