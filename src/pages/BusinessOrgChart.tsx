...
export default function BusinessOrgChart() {
  const { user } = useAuth();
  ...
  return (
    <BusinessLayout title="Organizational Chart" description="Visualize your company hierarchy and reporting structure">
      {loading ? (
